...
days:
  ...
  - num: 4
    ...
    items:
      ...
      - time: 19:30 – 21:30
        title: 🧺 衣博士自助洗衣 日月潭店 · 行程过半补给
        detail: |
          行程正好过半，趁今晚在日月潭落脚把衣服一口气洗了 — 阿里山、花莲两站停留都短，错过这次就得拖到台南 Day 6。店址在鱼池乡义勇街 34 号，从水社搭计程车约 10 分钟（单程 NT$200–250）。24 小时自助，洗 + 烘一次约 NT$150–200（投币或刷悠游卡）。
          <br><br>
          <strong>🚕 夜间叫车：</strong>水社在地车队「日月星光計程車」 0952-114995 / 0912-114995，21:00 后请直接电话预约回程，避免空等。水沙连柜台也可代叫。
        tickets:
          - { tag: 洗 + 烘, value: "NT$150–200" }
          - { tag: 营业, value: 24 小时自助 }
        links:
          - { type: map, icon: 📍, label: 衣博士自助洗衣 日月潭店, query: 衣博士自助洗衣 日月潭店 鱼池乡义勇街 }
    note: |
