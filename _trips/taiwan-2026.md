  ...
  - num: 2
    ...
    items:
      - time: 09:00 – 09:30
        ...
        transit: true
        detail: |
          单日租车，方便当日跨故宫博物院（士林）、阳明山国家公园（北投）两个景点 — 公车换乘需近 2 小时，自驾约 40 分钟。已预订经济款五人座（随机车型），取还车都在台北车站店，取车 09:00 / 还车 21:00 前。
          <br><br>
          <strong>⚠️ 取车时带齐：国际驾照 + 原本国驾照 + 护照。</strong>还车前记得加满油（取车时油表刻度为准）。
        tickets:
          - { tag: 已订, value: "NT$ 1,371", note: 经济款五人座 · 随机车型 }
          - { tag: 取还车, value: 09:00 取 / 21:00 前还 }
        links:
